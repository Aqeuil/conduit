    ...
    <div style={{ position: 'relative', width: '100%', height: '100%', minHeight: '80vh' }}>
      ...
      >
        <img
          src="/working.png"
          alt="working"
          style={{ maxWidth: '60%', maxHeight: '60vh', objectFit: 'contain', opacity: 0.85 }}
        />
      </div>

      <a
        href="https://github.com/Aqeuil/conduit"
        target="_blank"
      ...
      >
        <svg height="16" width="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
          <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38
            ...
            -.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.64 7.64 0 0 1 2-.27
